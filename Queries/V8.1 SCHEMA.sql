...
Description: Enhanced schema with automatic enrollment in default subjects, system configuration,
            ...
            This version includes robust existence checks for backwards compatibility.
*/
...
BEGIN TRY
    ...
    -- Insert version record for V8.1 if it doesn't exist
...
PRINT '=================================================';
PRINT 'Schema V8.1 installation complete';
